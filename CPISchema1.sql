...
(
	CUST_KEY 			INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
	...
	CHECK (e_mail_address REGEXP '[a-zA-Z0-9._%-]+@[a-zA-Z0-9._%-]+\.[a-zA-Z]{2,4}')
);
...
(	
	CUST_LOC_KEY		INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
	CITY 				VARCHAR(25) NOT NULL, 
...
(
	SALES_AGENT_ID 		INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(
	SALES_CLASS_ID 		INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(
	MACHINE_TYPE_ID		INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(
	LEAD_ID 		INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(
	SUB_JOB_ID 			INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(
	JOB_SHIPMENT_ID 			INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(
	FINANCIAL_SUMMARY_SALES_ID	INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(
	FINANCIAL_SUMMARY_COST_ID	BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
	ACTUAL_UNITS 				INTEGER NOT NULL, 
